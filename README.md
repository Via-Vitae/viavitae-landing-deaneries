...
[![CI](https://github.com/Via-Vitae/viavitae-landing-deaneries/actions/workflows/ci.yml/badge.svg)](https://github.com/Via-Vitae/viavitae-landing-deaneries/actions/workflows/ci.yml)
[![Compliance](https://github.com/Via-Vitae/viavitae-landing-deaneries/actions/workflows/compliance-check.yml/badge.svg)](https://github.com/Via-Vitae/viavitae-landing-deaneries/actions/workflows/compliance-check.yml)
[![CodeQL](https://github.com/Via-Vitae/viavitae-landing-deaneries/actions/workflows/codeql.yml/badge.svg)](https://github.com/Via-Vitae/viavitae-landing-deaneries/actions/workflows/codeql.yml)
...
`viavitae-landing-deaneries` is the single source of truth for how a ViaVitae repository looks.
...
gh repo create Via-Vitae/viavitae-<name> \
  --template Via-Vitae/viavitae-landing-deaneries \
  --private \
...
cd viavitae-<name>
git remote add upstream git@github.com:Via-Vitae/viavitae-landing-deaneries.git
```
...
Every ViaVitae repository is generated from `viavitae-landing-deaneries`. Governance files are not
